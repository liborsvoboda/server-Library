...
[^' +
    ...
    * */
    ...
    const select = (children = '', options = {}) => new Select$1(children, options);
    ...
    const upgradeQuery = () => {
        Query$1.prototype.plugin = function(name){
            if (!name) {
        ...
        Query$1.prototype.animate = function ({draw = {}, dur = 100, ease = "linear"} = {}, cb){
            return this.each((_, el)=>{
                Animation.animate({
                    el,
                    draw,
...
"]);
    ...
    class Dropdown extends Component {
        ...
        close(el){
            ...
            exec$1(dropdown.options.onCloseup, [dropdown.elem]);
    ...
    class ToolsMenu extends Component {
        ...
        constructor(elem, options) {
            if (!undef$1(globalThis["metroToolsMenuSetup"])) {
    ...
    class Table extends Component {
        ...
        setDataset(){
            ...
            if (o.dataset instanceof Dataset) ; else {
                isObjectType(o.dataset);
            }
        }
    ...
    class Master extends Component {
        ...
        constructor(elem, options) {
            if (!undef$1(globalThis["metroMasterSetup"])) {
        ...
        #showPage(){
            ...
            if (this.action !== MASTER_ACTION_INIT) {
                exec$1(o.onLeavePage, [this.page + 1, this.#prev()], this.#prev());
            }

            $(this.#current()).show(() => {
                exec$1(o.onEnterPage, [this.page + 1, this.#current()], this.#current());
            });
        ...
        #createEvents(){
            ...
            element.on("click", ".master__btn-help", (event) => {
                event.preventDefault();
                exec$1(o.onHelp, [this.page + 1, this.#current()], this.#current());
            });
            ...
            element.on("click", ".master__btn-prev", (event) => {
                ...
                exec$1(o.onBeforeEnterPage, [this.page + 1, this.#current()], this.#current());

                exec$1(o.onPrev, [this.page + 1, this.#current()], this.#current());
            ...
            element.on("click", ".master__btn-next", (event) => {
                ...
                if (exec$1(o.onBeforeLeavePage, [this.page + 1, this.#current()], this.#current()) === false) {
                    return
                }
                ...
                exec$1(o.onNext, [this.page + 1, this.#current()], this.#current());
            ...
            element.on("click", ".master__btn-finish", (event) => {
                event.preventDefault();
                exec$1(o.onFinish, [this.page + 1, this.#current()], this.#current());
            });
        }
    }
    ...
    class Sorter extends Component {
        ...
        constructor(elem, options) {
            if (!undef$1(globalThis['metroSorterSetup'])) {
    ...
    class Infobox {
        ...
        constructor(options) {
            if (!undef$1(globalThis["metroInfoboxSetup"])) {
        ...
        create(){
            ...
            exec$1(this.options.onOpen, [this.box[0]], this.box[0]);

            this.box.css({
                top: undef$1(o.top) ? ($(window).height() - this.box.outerHeight()) / 2 : o.top,
        ...
        destroy(){
            this.overlay.remove();
            exec$1(this.options.onClose, [this.box[0]], this.box[0]);
            this.box.remove();
            this.box = null;
        }
    ...
    class Select extends Component {
        ...
        constructor(elem, options) {
            if (!undef$1(globalThis["metroSelectSetup"])) {
